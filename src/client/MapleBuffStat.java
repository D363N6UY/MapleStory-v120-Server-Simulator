...
public enum MapleBuffStat implements Serializable {
    ...
    DARK_AURA(0x4000, true),
    BLUE_AURA(0x8000, true),
    YELLOW_AURA(0x10000, true),
	
//	WIDARD_BLEASS(0x100000000000L, true), //精靈的祝福
	

    ENERGY_CHARGE(0x80000, true),
