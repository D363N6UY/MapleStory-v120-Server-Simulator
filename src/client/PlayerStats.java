...
public class PlayerStats implements Serializable {
    ...
    public void recalcLocalStats(boolean first_login) {
        ...
        for (IItem item : chra.getInventory(MapleInventoryType.CASH)) {
            ...
            if (expMod < 3 && (itemId == 5211060 || itemId == 5211050 || itemId == 5211051 || itemId == 5211052 || itemId == 5211053 || itemId == 5211054)) {
                expMod = 3;//overwrite
                ...
                expMod = 2;
            } else if (expMod == 1 && itemId == 5210003 && hour >= 12 && hour <= 18) {
                expMod = 2;
            } else if (expMod == 1 && itemId == 5210004 && hour >= 18 && hour <= 24) {
                expMod = 2;
            }
            if (dropMod == 1) {
                if (itemId == 5360015) {
                    dropMod = 2;
                } else if (itemId == 5360000 && hour >= 0 && hour <= 6) {
                    dropMod = 2;
                } else if (itemId == 5360001 && hour >= 6 && hour <= 12) {
                    dropMod = 2;
                } else if (itemId == 5360002 && hour >= 12 && hour <= 18) {
                    dropMod = 2;
                } else if (itemId == 5360003 && hour >= 18 && hour <= 24) {
                    dropMod = 2;
                }
            }
            if (itemId == 5650000) {
                hasPartyBonus = true;
            } else if (itemId == 5590001) {
                levelBonus = 10;
            } else if (levelBonus == 0 && itemId == 5590000) {
                levelBonus = 5;
            }
        }
